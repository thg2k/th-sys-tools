...
test_script_exec(2, array(
    './scripts/tail_mail_log.php -S -c 999 ' .
...
// test_script_exec(3, array(
  // 'echo "# -B 99"',
  // './scripts/tail_mail_log.php -B 99 -c 999 ' .
      // './tests/standalone/test_tail_mail_log.data.log',
  // 'echo "# -B 100"',
  // './scripts/tail_mail_log.php -B 100 -c 999 ' .
      // './tests/standalone/test_tail_mail_log.data.log',
  // 'echo "# -B 101"',
  // './scripts/tail_mail_log.php -B 101 -c 999 ' .
      // './tests/standalone/test_tail_mail_log.data.log',
  // ), "test_tail_mail_log.case2");
